function lightDarkVar(baseName) {
  return ({ opacityValue }) =>
    opacityValue
      ? `var(--theme-light, hsl(var(--${baseName}) / ${opacityValue})) var(--theme-dark, hsl(var(--${baseName}-dark) / ${opacityValue}))`
      : `var(--theme-light, hsl(var(--${baseName}))) var(--theme-dark, hsl(var(--${baseName}-dark)))`;
}
