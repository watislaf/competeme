...
export const ChallengesApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
        /**
         * Adds a new challenge for the specified user
        ...
        /**
         * Removes a specific challenge from the user\'s profile
        ...
        /**
         * Retrieves all challenges for the specified user
        ...
        /**
         * Updates the details of an existing challenge
...
export const ChallengesApiFp = function(configuration?: Configuration) {
    ...
    return {
        ...
        async addChallenge(userId: number, challengeRequest: ChallengeRequest, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>> {
            ...
            const localVarOperationServerBasePath = operationServerMap['ChallengesApi.addChallenge']?.[localVarOperationServerIndex]?.url;
        ...
        async deleteChallenge(userId: number, challengeId: number, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>> {
            ...
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['ChallengesApi.deleteChallenge']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * Retrieves all challenges for the specified user
        ...
        async getChallenges(userId: number, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<ChallengeResponse>>> {
            ...
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['ChallengesApi.getChallenges']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * Updates the details of an existing challenge
        ...
        async modifyChallenge(userId: number, challengeId: number, challengeModificationRequest: ChallengeModificationRequest, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>> {
            ...
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['ChallengesApi.modifyChallenge']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * Updates the progress of a specific challenge
        ...
        async updateProgress(userId: number, challengeId: number, progress: number, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>> {
            ...
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['ChallengesApi.updateProgress']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
    }
};
...
export class ChallengesApi extends BaseAPI {
    ...
    public addChallenge(userId: number, challengeRequest: ChallengeRequest, options?: RawAxiosRequestConfig) {
        return ChallengesApiFp(this.configuration).addChallenge(userId, challengeRequest, options).then((request) => request(this.axios, this.basePath));
    }
    ...
    public deleteChallenge(userId: number, challengeId: number, options?: RawAxiosRequestConfig) {
        return ChallengesApiFp(this.configuration).deleteChallenge(userId, challengeId, options).then((request) => request(this.axios, this.basePath));
    }
    ...
    public getChallenges(userId: number, options?: RawAxiosRequestConfig) {
        return ChallengesApiFp(this.configuration).getChallenges(userId, options).then((request) => request(this.axios, this.basePath));
    }
    ...
    public modifyChallenge(userId: number, challengeId: number, challengeModificationRequest: ChallengeModificationRequest, options?: RawAxiosRequestConfig) {
        return ChallengesApiFp(this.configuration).modifyChallenge(userId, challengeId, challengeModificationRequest, options).then((request) => request(this.axios, this.basePath));
    }
    ...
    public updateProgress(userId: number, challengeId: number, progress: number, options?: RawAxiosRequestConfig) {
        return ChallengesApiFp(this.configuration).updateProgress(userId, challengeId, progress, options).then((request) => request(this.axios, this.basePath));
    }
}
